$(document).ready(function() {
  ...
  function createNewRow(todo) {
    ...
    newDeleteBtn.addClass("delete alert button");
    newDeleteBtn.attr("type", "button")
    newDeleteBtn.html("<i class='fa fa-times' aria-hidden='true'></i>");
    newDeleteBtn.data("id", todo.id);
    var newCompleteBtn = $("<button>");
    newCompleteBtn.addClass("complete button");
    newCompleteBtn.html("<i class='fa fa-check-square-o' aria-hidden='true'></i>");
